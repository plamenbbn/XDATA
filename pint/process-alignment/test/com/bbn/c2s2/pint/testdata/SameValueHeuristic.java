...
/**
 * An edge-weight heuristic that always returns the same weight.
 * 
 * @author tself
 * 
 */
public class SameValueHeuristic implements IEdgeWeightHeuristic {

	private double weight = 0.0;

	SameValueHeuristic(double w) {
		weight = w;
	}
	...
	public boolean linked(Binding bindingA,
			Binding bindingB) {
		return getLinkWeight(bindingA, bindingB) > 0.0;
	}
}
