...
public class OpposesEdgeWeightHeuristic extends PintConfigurable implements
	...
	public OpposesEdgeWeightHeuristic(RnrmProcess process, 
	...
	public double getLinkWeight(Binding bindingA,
		...
		// return 0;
		// }
		else if (process.opposes(bindingA.getActivity(), bindingB.getActivity())) {
			return 0;
		}
